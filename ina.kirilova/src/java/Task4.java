...
public class Task4 {
    public static void read() throws IOException {
        ...
        BufferedReader in = new BufferedReader(new FileReader("ina.kirilova/src/resources/text.txt"));
    ...
    public static void write() throws IOException {
        ...
        String text = "";
        BufferedReader reader = new BufferedReader(new FileReader("ina.kirilova/src/resources/text.txt"));
        ...
        FileWriter writer = new FileWriter("ina.kirilova/src/resources/text.txt");
